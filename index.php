...
$conexao = mysqli_connect("localhost", "root", "") or die("Não foi possível conectar com o banco de dados!");
...
if($acao == "editar"){
    ...
    $query = "UPDATE livro SET titulo='$titulo', autores='$autores', editora='$editora', edicao='$edicao', data='$data' where id='$id'";
    $res = mysqli_query($conexao, $query);
...
<html lang="pt-br">
    <head>
        ...
        function apagar( id ){
            ...
            if( resp == true ) location.href = 'index.php?acao=del&id=' + id;
        }

        function pesquisar(){
            var palavra = document.getElementById('palavra').value;
            location.href = 'index.php?acao=pesquisar&palavra=' + palavra;
        }
        </script>
    </head>
    <body>
        ...
        <div>
            ...
            <div style="margin-left:10%">
                <h2 class="pesq" style="margin-left: 0px; font-family: arial, sans-serif" >Pesquisar:</h2>
                <input type="text" name="palavra" id="palavra" value="<?=$palavra?>">
                <input style="background:gray; color:white" type="button" value="Pesquisar" onclick="pesquisar()">
            </div>
            <div>
            ...
            <table borde="1" cellpadding="5" cellspacing="25">
                <tr>
                    ...
                    <td width="240px" align="left"><strong>Ações<strong></td>
                </tr>

                <?php
                    if( $acao == "pesquisar")
                    $query = "SELECT * FROM livro WHERE titulo like '%$palavra%' or autores like '%$palavra%' order by titulo";
                else
                    ...
                    while($aux = mysqli_fetch_assoc($res)){
                        ...
                        echo '<a href="#" onclick="apagar(\''.$aux ['id'].'\')">Remover</a>';
                        echo ' | ';
